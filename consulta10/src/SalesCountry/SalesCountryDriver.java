...
public class SalesCountryDriver {
    public static void main(String[] args) {
        ...
        job_conf1.setJobName("QALIWARMA_Ratio_Job1");
        ...
        FileInputFormat.setInputPaths(job_conf2, new Path("/output_c10_temp"));
        FileOutputFormat.setOutputPath(job_conf2, new Path("/output_c10"));
